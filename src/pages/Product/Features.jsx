      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg transition transform hover:-translate-y-1 hover:scale-105">
              ...
              <p>
                Forecast potential delays and optimize logistics with proactive
                insights.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg transition transform hover:-translate-y-1 hover:scale-105">
        ...
        <section className="mb-12 text-center">
          ...
          <p className="max-w-3xl mx-auto">
            ...
            practices to deliver unmatched cost savings, advanced analytics, and
            a future-proof strategy for maritime logistics.
          </p>
        </section>
