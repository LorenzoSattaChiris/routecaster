...
const Terms = () => {
  return (
    <>
      <Helmet>
        <title>RouteCaster | Terms and Conditions</title>
        <meta
          name="description"
          content="Review the terms and conditions governing the use of RouteCaster."
        />
        <meta
          property="og:title"
          content="RouteCaster | Terms and Conditions"
        />
        <meta
          property="og:description"
          content="Review the terms and conditions governing the use of RouteCaster."
        />
        <meta property="og:url" content="https://www.routecaster.com/terms" />
        <link rel="canonical" href="https://www.routecaster.com/terms" />
        <meta
          name="twitter:title"
          content="RouteCaster | Terms and Conditions"
        />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-700 mb-6">
          <i>Last updated February 10, 2025</i>
        </p>
        ...
        <p className="text-gray-700 mb-4">
          We are <b>RouteCaster</b> ("Company", "we", "us", or "our"), a company
          registered in the United Kingdom at Stocker Rd, Exeter, Devon EX44PY.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          We Provide Cost Based Fleet Wide Route Optimization.
        </p>
        <p className="text-gray-700 mb-4">
          ...
          or by mail to Stocker Rd, Exeter, Devon EX44PY, United Kingdom.
        </p>
        <p className="text-gray-700 mb-4">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and
          RouteCaster, concerning your access to and use of the Services. You
        ...
        <p className="text-gray-700 mb-4">
          Email to users if changes are significant. To the discretion of the
          Company.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4">
          ...
          <li>Copy the proprietary algorithms in any way</li>
          <li>
            The Software should not be merged, compiled, copied, partially
            copied, distributed, alterated, modified, disclosed, reverse
            engineered, disassembled, decompiled, sold or partially distributed.
          </li>
          <li>
            The Software should not be copied, reused or shared in any form
        ...
        <>
          ...
          <ul className="list-decimal list-inside text-gray-700 mb-4">
            ...
            <li>
              In our sole discretion and without limitation, without notice or
              liability, remove from the Services or otherwise disable all files
          ...
          <p className="text-gray-700 mb-4">
            ...
            Services are hosted in the United Kingdom. If you access the
            ...
            to the United Kingdom, and you expressly consent to have your data
          ...
          <p className="text-gray-700 mb-4">
            ...
            obligatory provisions of the law in your country of residence.
            RouteCaster and yourself both agree to submit to the non-exclusive
            jurisdiction of the courts of Devon, which means that you may make a
          ...
          <p className="text-gray-700 mb-4">
            ...
            the time the application for arbitration is filed, and by adopting
            this clause you accept these terms. The seat of arbitration shall be
            Exeter, United Kingdom. The language of the proceedings shall be
          ...
          <p className="text-gray-700 mb-4">
            ...
            to and use of the Services, (3) any unauthorised access to or use of
          ...
          <p className="text-gray-700 mb-4">
            For urgent one‑time communication or verification purposes.
          </p>
          <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
            Opting Out
          </h3>
          <p className="text-gray-700 mb-4">From the Dashboard.</p>
          <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">
