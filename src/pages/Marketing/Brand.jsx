...
const Brand = () => {
  return (
    <>
      <Helmet>
        <title>RouteCaster | Brand Assets</title>
        <meta
          name="description"
          content="Access the official RouteCaster brand assets, logos, and style guidelines."
        />
        <meta property="og:title" content="RouteCaster | Brand Assets" />
        <meta
          property="og:description"
          content="Access the official RouteCaster brand assets, logos, and style guidelines."
        />
        <meta property="og:url" content="https://www.routecaster.com/brand" />
        <link rel="canonical" href="https://www.routecaster.com/brand" />
        <meta name="twitter:title" content="RouteCaster | Brand Assets" />
        <meta
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-300">
                  ...
                  <li className="flex items-center">
                    <div className="w-4 h-4 mr-2 bg-[#2c3e50]"></div>#2c3e50
                    (Text - Dark Grey)
                  </li>
                  <li className="flex items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-300 mb-3">
                    The RouteCaster logo is our most valuable brand asset.
                    Always use approved logo files and maintain these
                    requirements:
                  </p>
                  <ul className="list-disc list-inside text-gray-300 ml-4">
                    <li>
                      Maintain minimum clear space of 1x logo height on all
                      sides
                    </li>
                    <li>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-300 mb-3">
                    Consistent typography helps maintain our brand's
                  ...
                  <ul className="list-disc list-inside text-gray-300 ml-4">
                    ...
                    <li>
                      Maintain proper hierarchy and spacing between text
                      elements
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-300 mb-3">
                    Our color palette conveys trust, innovation, and
                    reliability:
                  </p>
                  <ul className="list-disc list-inside text-gray-300 ml-4">
                    <li>
                      Primary blue (#205cef) for main CTAs and key brand
                      elements
                    </li>
                    <li>
