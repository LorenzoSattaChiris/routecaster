...
const About = () => {
  return (
    <>
      <Helmet>
        <title>RouteCaster | About</title>
        <meta
          name="description"
          content="Learn more about RouteCaster, our mission, and our dedicated team shaping the future of maritime logistics."
        />
        <meta property="og:title" content="RouteCaster | About" />
        <meta
          property="og:description"
          content="Learn more about RouteCaster, our mission, and our dedicated team shaping the future of maritime logistics."
        />
        <meta property="og:url" content="https://www.routecaster.com/about" />
        <link rel="canonical" href="https://www.routecaster.com/about" />
        <meta name="twitter:title" content="RouteCaster | About" />
        <meta
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                  ...
                  <p>
                    Empower businesses with innovative AI solutions that
                    transform logistics and shipping operations.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p>
                ...
                fleet operators around the globe with cutting‑edge technology
