...
const Signup = () => {
  ...
  return (
    <>
      <Helmet>
        <title>RouteCaster | Signup</title>
        <meta
          name="description"
          content="Create a new RouteCaster account and start optimising your fleet routes today."
        />
        <meta property="og:title" content="RouteCaster | Signup" />
        <meta
          property="og:description"
          content="Create a new RouteCaster account and start optimising your fleet routes today."
        />
        <meta property="og:url" content="https://www.routecaster.com/signup" />
        <link rel="canonical" href="https://www.routecaster.com/signup" />
        <meta name="twitter:title" content="RouteCaster | Signup" />
        <meta
